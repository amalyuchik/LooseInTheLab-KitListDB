...
class classroom_kit_list_item
{
    ...
    public function __construct(array $source_product)
    {
        ...
        if ($source_product['reusable']) {
            $this->reusable_qty = $source_product['lab_product_line_classroom_qty'];
            $this->product_reusable_price = $source_product['product_price']*$source_product['lab_product_line_classroom_qty'];
        }
        else {
            $this->consumable_qty = $source_product['lab_product_line_classroom_qty'];
            $this->product_consumable_price = $source_product['product_price']*$source_product['lab_product_line_classroom_qty'];
        }
        //$this->source_product = [];
        return $this;
    }
